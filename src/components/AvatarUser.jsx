...
export default function AvatarUser({ avatar, name }) {
  return (
        ...
        <div className="flex gap-x-5 items-center">
          <div className="relative w-12">
            <img
              src={
                avatar ||
                "https://p6.douyinpic.com/img/tos-cn-avt-0015/847dfd2865ed5d75ee1b147029e85572~c5_100x100.jpeg?from=2956013662"
              }
              alt=""
